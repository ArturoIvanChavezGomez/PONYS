    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'active' => ['teacher/groups*']
        ],
        [
            'text' => 'Alumnos',
            'route'  => 'teacher.users.index',
            'icon' => 'fas fa-fw fa-user',
        ],
        /* [
            'text'    => 'multilevel',
